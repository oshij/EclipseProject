...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="customer-registration">Registration</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="customer-login">Login</a>
                    </li>
                </ul>
            </div>
        </div>
	...
	%>
	    <div id="success-alert" class="alert alert-success sticky-top" role="alert">
		  Customer Registration Successful! Your ID is: <%= id %>
		</div>
    <%
		}
	%>
    ...
    <div class="container">
        <div id="login" class="form-container col-10 col-md-9 col-lg-5 mx-auto">
            <h2 class="text-center mb-4">Customer Log In</h2>
            <form id="login-form" class="needs-validation" method="post" action="customer-login" novalidate>
                <div class="mb-3">
