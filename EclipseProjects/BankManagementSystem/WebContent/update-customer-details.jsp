...
<body>
	...
	<%
		String searchSsnId = request.getSession().getAttribute("search-ssn-id") != null ? String.valueOf(request.getSession().getAttribute("search-ssn-id")) : "";
	%>
    ...
    <div class="container">
        <ul class="nav nav-pills mt-1">
			...
			<li class="nav-item">
		    	<button class="nav-link active" type="button" onclick="window.location.href='update-customer-details'">Update Customer Details</button>
		  	</li>
			<li class="nav-item">
		...
		<div>
	    	<div class="form-container col-10 col-md-9 col-lg-5 mx-auto">
	    		<form id="search-form" class="mb-3" method="post" action="update-customer-details" novalidate>
		    		<input type="hidden" name="type" value="search">
	                <div>
	                    <label class="form-label">Customer SSN ID</label>
                		<div class="row">
                			<div class="w-75">
	                    		<input id="ssn-id" type="number" class="form-control" name="search-ssn-id" value="<%=searchSsnId%>" required>
	                    	</div>
				...
				<% 
                	...
                	String contactNumnber = customer != null ? customer.getContactNumber() : "";
				%>
	            <form id="update-form" method="post" action="update-customer-details" novalidate>
		    		<input type="hidden" name="type" value="update">
		    		<input id="ssn-id" type="number" class="form-control d-none" name="search-ssn-id" value="<%=searchSsnId%>" required>
	                <div class="row">
		                <div class="col-md-6 mb-3">
		                    <label class="form-label">First Name</label>
		                    <input type="text" class="form-control" name="first-name" value="<%= firstName %>" required>
							<div class="invalid-feedback">Cannot be blank!</div>
		                </div>
	                    <div class="col-md-6 mb-3">
	                        <label class="form-label">Last Name</label>
	                        <input type="text" class="form-control" name="last-name" value="<%= lastName %>" required>
	    					<div class="invalid-feedback">Cannot be blank!</div>
	                    </div>
		            </div>
	                <div class="row">
	                    ...
	                    <div class="col-md-6 mb-3">
	                        ...
	                        <input type="text" pattern="^[a-zA-Z]{4}[0-9]{7}$" name="ifsc" class="form-control" value="<%= ifsc %>" required>
	                ...
	                <div class="row">
	                   <div class="col-md-6 mb-3">
	                       	...
	                       	<input type="text" pattern="^[0-9]{12}$" name="aadhaar-number" class="form-control" value="<%= aadhaarNumber %>" required>
	   						<div class="invalid-feedback">Enter a valid Aadhaar number!</div>
	                   </div>
	                   <div class="col-md-6 mb-3">
	                       	<label class="form-label">PAN Number</label>
	                       	<input type="text" pattern="^[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}$" name="pan-number" class="form-control" value="<%= panNumber %>" required>
	                ...
	                <div class="row">
		                ...
		                <div class="col-md-6 mb-3">
		                    ...
		                    <input type="tel" name="contact-number" pattern="^[0-9]{10}$" class="form-control" value="<%= contactNumnber %>" required>
